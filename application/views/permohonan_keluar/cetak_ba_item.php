...
<div class="content">
    ...
    telah dikeluarkan kendaraan operasional/peralatan GSE ke Sisi Udara
...
var bc_sales    = <?= json_encode($fmt($nama_sales,    $gse->sales_at    ?? $permohonan->verifikasi_sales_at    ?? $permohonan->updated_at)) ?>;
var bc_ops      = <?= json_encode($fmt($nama_operasi,  $gse->operasi_at  ?? $permohonan->verifikasi_operasi_at  ?? $permohonan->updated_at)) ?>;
var bc_security = <?= json_encode($fmt($nama_security, $gse->security_at ?? $permohonan->verifikasi_security_at ?? $permohonan->updated_at)) ?>;
